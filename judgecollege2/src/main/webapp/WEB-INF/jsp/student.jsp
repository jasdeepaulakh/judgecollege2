		...
		<div class="page-header" id="banner">
			<div class="jumbotron">
				...
				<button type="button" class="btn btn-danger btn-sm"
					data-toggle="modal" data-target="#report">Report Issue</button>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">Error Reported</h4>
							</div>
							<div class="modal-body">
								<p>You're issue has been logged. An admin will be in touch</p>
							</div>
				...
				<div class="bs-component">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#profile" data-toggle="tab"
							aria-expanded="true">My Profile</a></li>
						<li class=""><a href="#courseDetails" data-toggle="tab"
							aria-expanded="false">View Course Details</a></li>
						<li class=""><a href="#courseReg" data-toggle="tab"
							aria-expanded="false">Course Registration</a></li>
						<li class=""><a href="#paySchedule" data-toggle="tab"
							aria-expanded="false">Payment Schedule</a></li>
						<li class=""><a href="#reportCard" data-toggle="tab"
							aria-expanded="false">Report Card</a></li>
					</ul>
							...
							<div class="bs-docs-section">
								<div class="row">
									<div class="col-lg-12">
										...
										<a class="btn btn-primary" href="student-account">Update
											Details</a>
									</div>
								</div>
							</div>
